...
export const OrderVeiw: React.FC<OrderViewProps> = ({ orderData }) => {
  ...
  const status = () => {
    if (orderData.status == 'on-hold')
      return 'Awaiting payment to arrive into my bank account, Revolut, or my manual confirmation if paid in cash. Payment details sent by email, please check your mailbox.';
